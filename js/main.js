...
function nestlyEnquire(id) {
  ...
  alert(`Thanks for your interest in "${name}"!\n\nThis is a demo — in the live site this would open an enquiry form or send your details to the Nestly team. Call +91 99412 40338 or email sekar19.t@gmail.com to book a viewing.`);
}

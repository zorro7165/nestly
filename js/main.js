...
function nestlyEnquire(id) {
  ...
  alert(`Thanks for your interest in "${name}"!\n\nThis is a demo — in the live site this would open an enquiry form or send your details to the Nestly team. Call +91 98765 43210 or email hello@nestlyhomes.in to book a viewing.`);
}
